...
// Member can only see their assigned clients
const mockMyClients = [
  { id: 1, name: "John Smith", phone: "+1 234 567 890", lastMessage: "Thanks for your help!", lastMessageTime: "2m ago", unreadCount: 2 },
  { id: 2, name: "Sarah Johnson", phone: "+1 234 567 891", lastMessage: "When will my order arrive?", lastMessageTime: "15m ago", unreadCount: 0 },
  { id: 3, name: "Mike Wilson", phone: "+1 234 567 892", lastMessage: "I need to reschedule", lastMessageTime: "1h ago", unreadCount: 1 },
];
...
const MemberChats = () => {
  const [selectedClient, setSelectedClient] = useState(mockMyClients[0]);
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <DashboardHeader title="My Chats" />
